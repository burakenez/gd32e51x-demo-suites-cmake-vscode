...
#if (defined(GD32EPRTxxA) || defined(GD32E51X_HD) || defined(GD32E51X_XD))
    /* reset HXTALEN, CKMEN and PLLEN bits */
    RCU_CTL &= ~(RCU_CTL_PLLEN | RCU_CTL_CKMEN | RCU_CTL_HXTALEN);
    /* disable all interrupts */
    RCU_INT = 0x009f0000U;
#elif (defined(GD32E51X_CL) || defined(GD32E517))
    /* Reset HXTALEN, CKMEN, PLLEN, PLL1EN and PLL2EN bits */
    RCU_CTL &= ~(RCU_CTL_PLLEN |RCU_CTL_PLL1EN | RCU_CTL_PLL2EN | RCU_CTL_CKMEN | RCU_CTL_HXTALEN);
    /* disable all interrupts */
    RCU_INT = 0x00ff0000U;
#endif /* GD32E51X_EPRT and GD32E51X_HD and GD32E51X_XD */
...
#if (defined(GD32E51X_HD) || defined(GD32E51X_XD))
...
#endif /* GD32E51X_HD and GD32E51X_XD */
...
{
    uint32_t sws;
    uint32_t pllsel, predv0sel, pllpresel, pllmf, ck_src, idx, clk_exp;
#if (defined(GD32E51X_CL) || defined(GD32EPRTxxA) || defined(GD32E517))
    uint32_t predv0, predv1, pll1mf;
#endif /* GD32E51X_CL and GD32EPRTxxA*/
...
#elif (defined(GD32E51X_CL) || defined(GD32EPRTxxA) || defined(GD32E517))
...
#endif /* GD32E51X_CL and GD32EPRTxxA and GD32E517 */
