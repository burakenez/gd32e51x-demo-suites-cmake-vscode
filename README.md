[![GitHub tag (latest by date)](https://img.shields.io/github/v/tag/burakenez/gd32e51x-demo-suites-cmake-vscode)](https://github.com/burakenez/gd32e51x-demo-suites-cmake-vscode/tags/)

# GD32E51x Demo Suites CMake Visual Studio Code Integration

🚀 Welcome to the **GD32E51x Demo Suites CMake Visual Studio Code** repository! This project is designed to integrate the CMake build system with Visual Studio Code, providing a streamlined development environment for **_GD32E51x Demo Suites V1.2.0_**.
...
- **🧩 Lightweight Templates:** A structured and organized template for GD32E51x microcontroller projects.
...
- **Notes:**
  ...
  - Update paths in these files if necessary:
    - `Projects/<BoardName>/<ProjectName>/.vscode/launch.json` (lines 14, 17):
      ...
      ```
      ```json
      "${workspaceFolder}/../../../Tools/xpack-openocd-0.11.0-3/scripts/target/openocd_gdlink_gd32e51x.cfg"
      ```
...
### 2. **CMSIS/GD/GD32E51x**
- **Version:** `V1.2.0 (2024-12-30)`
- **Path:** `Drivers/CMSIS/GD/GD32E51x`
- Extracted from `GD32E51x Demo Suites V1.2.0`

### 3. **GD32E51x_standard_peripheral**
- **Version:** `V1.2.0 (2024-12-30)`
...
git clone --recursive https://github.com/burakenez/gd32e51x-demo-suites-cmake-vscode.git
```
...
│           │   ├── Core
│           │   │   ├── Inc
│           │   │   │   ├── gd32e51x_it.h  # Interrupt handler declarations specific to GD32E51x.
│           │   │   │   ├── gd32e51x_libopt.h  # Library options and configurations for efficient use.
│           │   │   │   └── systick.h  # Definitions and declarations related to the SysTick timer.
│           │   │   ├── Src
│           │   │   │   ├── gd32e51x_it.c  # Interrupt service routine implementations.
│           │   │   │   ├── main.c  # Entry point of the application, containing the main logic and system initialization.
│           │   │   │   ├── system_gd32e51x.c  # System initialization, clock setup, and core configurations.
│           │   │   │   └── systick.c  # SysTick timer setup and related functionalities.
│           │   ├── Startup
│           │   │   └── startup_gd32e51x.s  # Assembly code for initialization and vector table setup.
│           │   ├── User
...
│           ├── Drivers
│           │   ├── BSP/GD32E518C_START  # Board support package configurations and drivers for GD32E518C_START.
│           │   ├── CMSIS  # CMSIS drivers for Cortex-M processors, supporting GD32E51x.
│           │   └── GD32E51x_standard_peripheral  # Peripheral library for GD32E51x.
...
│           ├── gd32e51x_flash.ld  # Linker script for defining memory regions and placements.
│           └── GD32E51x.svd  # System View Description file for debugging and register definitions. 
